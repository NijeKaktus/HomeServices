...
export default function PrijavaPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        alert(`Uspešna prijava! Dobrodošli, ${data.user.name}!`);
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Ili{' '}
          <a href="/registracija" className="font-medium text-blue-600 hover:text-blue-500">
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">Ili se prijavite preko</span>
              </div>
            </div>

            <div className="mt-6">
              <button
                onClick={() => alert('Google prijava će biti implementirana uskoro!')}
